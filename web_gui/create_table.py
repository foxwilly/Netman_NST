...
#conn.execute('CREATE TABLE routers (hostname TEXT, type TEXT, username TEXT, password TEXT, file TEXT, interface TEXT, ip TEXT, proto TEXT)')
conn.execute("CREATE TABLE steps (name TEXT, step TEXT, action TEXT, status TEXT, checks TEXT, question TEXT)")
